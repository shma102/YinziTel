 ...
 */
public class FinancePayBackActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void payBack_Http() {
        VolleyRequestUtil.RequestPost(this, URL.HOST, "payback", getPaybckParams(), new VolleyListenerInterface(this, VolleyListenerInterface.mListener, VolleyListenerInterface.mErrorListener) {
            ...
            public void onMySuccess(String result) {
                ...
                Log.e("tag", payBackBean.toString());
            ...
            public void onMyError(VolleyError error) {
                ToastHelper.showToast(FinancePayBackActivity.this, "网络出错了");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.jixu:
                FinancePayBackActivity.this.finish();
                break;
